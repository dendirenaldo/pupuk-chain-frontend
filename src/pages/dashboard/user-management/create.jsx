...
const Create = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios({
            method: 'PATCH',
            url: `${process.env.NEXT_PUBLIC_RESTFUL_API != undefined ? process.env.NEXT_PUBLIC_RESTFUL_API : ''}/user`,
            data: form,
            headers: {
            ...
            if (res.data?.id) {
                Swal.fire('Berhasil', 'User created successfully!', 'success').then((res) => {
                    ...
                    <div className="card-body">
                        <div className="row">
                            ...
                            <div className="col-md-4 mb-3">
                                ...
                                <input type="password" className={`form-control ${passwordError !== '' ? 'is-invalid' : ''}`} id='password' value={password} onChange={(e) => setPassword(e.target.value)} required />
                                {passwordError !== '' && (
...
Create.getLayout = function getLayout(page) {
    return (
        <DashboardLayout header='Create User' breadCrumb={[{ label: 'Dashboard', link: '/dashboard' }, { label: 'User Managament', link: '/dashboard/user-management' }, { label: 'Create User Managament', link: '/dashboard/user-management/create' }]} breadCrumbRightContent={
