...
const Edit = ({ id }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios({
            ...
            if (res.data?.id) {
                Swal.fire('Success', 'Pupuk updated successfully!', 'success').then((res) => {
...
Edit.getLayout = function getLayout(page) {
    const { id } = page.props;
    return (<DashboardLayout header='Edit Pupuk' breadCrumb={[{ label: 'Dashboard', link: '/dashboard' }, { label: 'Pupuk', link: '/dashboard/pupuk' }, { label: 'Edit Pupuk', link: '/dashboard/pupuk/edit/' + id }]} breadCrumbRightContent={
