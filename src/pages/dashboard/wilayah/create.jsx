...
const Create = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios({
            method: 'PATCH',
            url: `${process.env.NEXT_PUBLIC_RESTFUL_API != undefined ? process.env.NEXT_PUBLIC_RESTFUL_API : ''}/wilayah`,
            data: {
                nama,
            ...
            if (res.data?.id) {
                Swal.fire('Success', 'Wilayah created successfully!', 'success').then((res) => {
...
Create.getLayout = function getLayout(page) {
    return (<DashboardLayout header='Create Wilayah' breadCrumb={[{ label: 'Dashboard', link: '/dashboard' }, { label: 'Wilayah', link: '/dashboard/wilayah' }, { label: 'Create Wilayah', link: '/dashboard/wilayah/create' }]} breadCrumbRightContent={
